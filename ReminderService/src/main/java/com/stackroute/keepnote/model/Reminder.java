...
public class Reminder {
	...
	public Reminder(String reminderId, String reminderName, String reminderDescription, String reminderType, String reminderCreatedBy, Date reminderCreattionDate) {
		this.reminderId = reminderId;
		this.reminderName = reminderName;
		this.reminderDescription = reminderDescription;
		this.reminderType = reminderType;
		this.reminderCreatedBy = reminderCreatedBy;
		this.reminderCreationDate = reminderCreattionDate;
	}
	...
	public String toString() {
		return "Reminder{" +
				...
				", reminderCreattionDate=" + reminderCreationDate +
				'}';
	}
}
